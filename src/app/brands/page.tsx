...
// //               className="pl-10 pr-10 py-2 bg-gray-100 border-none rounded-full"
// //             />
// //             <Button 
// //               variant="ghost" 
// //               size="icon" 
...
// //             {[...Array(8)].map((_, index) => (
// //               <Skeleton key={index} className="h-24 rounded-lg bg-gray-200" />
// //             ))}
// //           </div>
// //         )}
...
// //               <div
// //                 className="flex items-center justify-center h-24 border border-gray-200 rounded-lg cursor-pointer hover:shadow-md transition-all duration-200 bg-white"
// //                 key={brand._id}
// //                 onClick={() => handleBrandClick(brand.name, brand.company_logo, brand._id)}
// //               >
// //                 <figure className="flex flex-col items-center justify-center p-4 w-full h-full">
// //                   <img
...
//   // Filter brands when searchTerm changes
//   useEffect(() => {
//     if (searchTerm.trim() === '') {
//       setFilteredBrands(brandsList);
//     } else {
...
//   return (
//     <div className="flex flex-col min-h-screen bg-gray-50 at-maincontentwrapper">
//       {/* Header - Just the back button and title */}
