...
// //   fetchBrandDetails,
// //   placeOrder,
// //   fetchCategoryList, // **** IMPORT fetchCategoryList ****
// //   confirmOrder,
// // } from '@/services/api.service';
// // import { toast } from 'react-toastify';
// // import DealOfDay from './dealofday'; // Assuming DealOfDay can accept backgroundColor prop
...
// //   name: string;
// //   description: string;
// //   quantity: number; // Assuming this exists based on usage, might not be in API response
// //   price: number;
// //   image_path: string;
// //   background_image: string[]; // Renamed from background_image in original code, matches TopPicks
// //   is_featured: boolean;
// //   sticker_path: string;
// //   total_rating: number;
// //   category_id: string; // **** NEED THIS for background color logic ****
// // }
...
// //   name: string;
// //   company_logo: string;
// //   featured_image: string; // Assuming this exists based on usage
// // }

// // // **** ADD Category and CategoryApiResponse Interfaces ****
// // interface Category {
// //   _id: string;
// //   name: string;
// //   description: string;
...
// //   const BASE_URL = process.env.NEXT_PUBLIC_IMAGE_BASE_URL || ''; // Provide default for BASE_URL
...
// //   const [isPlacingOrder, setIsPlacingOrder] = useState(false); // Keep if used
// //   const [selectedSize, setSelectedSize] = useState('M'); // Default size or manage based on product specs
...
// //     try {
// //       // Fetch products, brand details (if needed beyond logo), and categories concurrently
// //       const [productResponse, categoryResponse] = await Promise.all([
// //         fetchProductDetails(brandId as string), // Fetch products for the specific brand
// //         fetchCategoryList(), // Fetch all categories to get the 'type'
// //         // Optionally fetch brand details if needed: fetchBrandDetails(brandId)
// //       ]);
...
// //         const allProds = productResponse.data || [];
// //         setProducts(allProds);
// //         // Ensure products have category_id, otherwise background logic won't work
// //         if (allProds.length > 0 && !allProds[0].category_id) {
// //           console.warn(
// //             "Products fetched do not contain 'category_id'. Background color cannot be applied."
// //           );
// //         }
// //         // Filter featured products
// //         const featured = allProds.filter(
// //           (product: Product) => product.is_featured
// //         );
// //         setFeaturedProducts(featured);
// //       } else {
// //         fetchError = productResponse?.message || 'Failed to load products';
...
// //         fetchError = fetchError ? `${fetchError}; ${catError}` : catError; // Combine errors
// //       }
...
// //       // Fetch Brand Logo (can be separate or part of a combined brand fetch)
// //       const storedLogo = sessionStorage.getItem(`brandLogo`);
// //       if (storedLogo) {
// //         setBrandLogo(storedLogo);
// //       } else {
// //         // If brand details endpoint exists and returns logo:
// //         // const brandDetailsResponse = await fetchBrandDetails(brandId); // Adjust API call
// //         // if (brandDetailsResponse?.success && brandDetailsResponse.data?.company_logo) {
// //         //     setBrandLogo(brandDetailsResponse.data.company_logo);
// //         //     sessionStorage.setItem(`brandLogo_${brandId}`, brandDetailsResponse.data.company_logo);
// //         // } else {
// //         // Fallback: Try to get logo from the first product's company details if available
// //         if (
// //           productResponse?.success &&
// //           productResponse.data?.[0]?.company_id?.company_logo
// //         ) {
// //           const logo = productResponse.data[0].company_id.company_logo;
// //           setBrandLogo(logo);
// //           sessionStorage.setItem(`brandLogo_${brandId}`, logo);
// //         } else {
// //           console.warn('Could not fetch brand logo.');
// //         }
// //         // }
// //       }
// //     } catch (err: any) {
...
// //       setLoading(false);
// //     }
// //   }, [brandId]); // Depend only on brandId

// //   // Call fetchInitialData when component mounts or brandId changes
// //   useEffect(() => {
// //     fetchInitialData();
// //   }, [fetchInitialData]);
// //   // --- End Data Fetching ---
...
// //       if (!category) {
// //         return '#D6DADA'; // Default if category not found in the list
// //       }
...
// //           return '#40A574';
// //         default:
// //           return '#D6DADA'; // Default for unknown types
// //       }
// //     },
// //     [categories]
// //   ); // Depend on categories state
...
// //       );
// //     }
// //     // Don't render section if not loading and no featured products
// //     if (!loading && featuredProducts.length === 0) {
// //       return (
...
// //                   <img
// //                     // Use sticker_path or image_path
// //                     src={
...
// //     // Assuming DealOfDay takes one featured product or the first product?
// //     // Let's use the first featured product if available, else the first product overall.
// //     const dealProduct = featuredProducts[0] || products[0];

// //     if (loading && !dealProduct) {
// //       return <Skeleton className="mt-7 h-40 w-full bg-[#d6dadb]" />;
// //     }
// //     if (!loading && !dealProduct) {
// //       return (
// //         <p className="mt-7 font-xl text-center text-gray-500">
// //           No Products Deals Available.
// //         </p>
// //       ); // Don't render if no products
// //     }

// //     // **** Calculate background color for the deal product ****
// //     const backgroundColor = getProductBackgroundColor(dealProduct.category_id);

// //     return (
// //       <div className="mt-8">
// //         {/* Assuming DealOfDay component can accept and use a backgroundColor prop */}
// //         {/* You might need to adjust the DealOfDay component itself */}
// //         <DealOfDay
// //           productImage={
// //             dealProduct.sticker_path ||
// //             dealProduct.image_path ||
// //             PRODUCT_PLACEHOLDER
// //           }
// //           productName={dealProduct.name || 'Special Deal'}
// //           backgroundColor={backgroundColor} // **** Pass background color ****
// //           // Pass other necessary props to DealOfDay
// //         />
// //       </div>
// //     );
// //   };
...
// //         {error && (
// //           <p className="error-message text-center text-red-600 mb-4">{error}</p>
// //         )}
// //         {/* Brand Header */}
...
// //             {typeof brandname === 'string'
// //               ? decodeURIComponent(brandname) // Decode brand name from URL
// //               : 'Brand'}{' '}
// //             Shop
// //           </h1>
// //         </div>
...
// //       {/* End IIFE for First Modal */}
// //       {/* Personalization Modal */}
// //       {isFirstModalOpen &&
// //         selectedProduct &&
// //         (() => {
// //           const modalCategoryId = selectedProduct.category_id;
...
// //         selectedProduct &&
// //         (() => {
// //           // **** Calculate background color for modal ****
// //           const modalCategoryId = selectedProduct.category_id;
// //           const modalBackgroundColor =
// //             getProductBackgroundColor(modalCategoryId);
...
// //                   <div className="at-modalcontent p-0">
// //                     <div
// //                       className="at-modalleftside at-modalordersummeryleft "
// //                       style={{ backgroundColor: modalBackgroundColor }}
// //                     >
// //                       <button
// //                         onClick={() => setIsSecondModalOpen(false)}
...
// // //src/components/Project/brand_shop.tsx
// // 'use client';
// // import { useEffect, useState, useCallback } from 'react';
// // import { useParams, useRouter } from 'next/navigation';
// // import { Skeleton } from '@/components/ui/skeleton';
...
// // } from '@/services/api.service';
// // import { toast } from 'react-toastify';
// // // Removed DealOfDay import, will create/use a new PromoSlider component or inline render
// // import RatingStars from '../page-ui/rating_stars';
// // import Link from 'next/link';

// // const PRODUCT_PLACEHOLDER = '/images/logoicons.png';
// // const BASE_URL = process.env.NEXT_PUBLIC_IMAGE_BASE_URL || '';
// // const MODEL_BG_PATH = '/images/model-bg'; // For modal default backgrounds
...
// //   // For cart quantity, not directly from backend product list
// //   quantity?: number; // Add if used for cart item structure
// // }
...
// //   _id: string;
// //   name: string; // Often duplicated from product_id.name
// //   description: string; // Often duplicated
// //   price: number; // Original price, often duplicated
// //   is_active: boolean;
// //   created_at: string;
// //   sticker_path: string | null;
// //   image_path: string | null;
...
// //   start_date: string;
// //   end_date: string;
// //   company_id: CompanyMin; // Assuming company_id in promo is an object
// //   title: string;
// //   description: string;
// //   promo_image: string;
// //   discount_percentage: number;
// //   promo_slider: string; // Main image for the promo slider itself
...
// // // --- Helper Functions for Styling (like category_page.tsx) ---
...
// //   const [isFirstModalOpen, setIsFirstModalOpen] = useState(false);
// //   const [isSecondModalOpen, setIsSecondModalOpen] = useState(false);
// //   const [processing, setProcessing] = useState(false); // Renamed from isPlacingOrder
...
// //         globalDataResponse, // For promos
// //         categoriesResponse, // For all categories for styling
// //       ] = await Promise.all([
// //         fetchProductDetails(brandId as string),
// //         fetchStickerList(), // This endpoint provides promoProducts
// //         fetchCategoryList(),
// //       ]);

// //       let fetchError: string | null = null;

// //       // Process Brand-Specific Products
...
// //         // Set brand logo from the first product of the brand or sessionStorage
// //         const storedLogo = sessionStorage.getItem(`brandLogo`);
// //         if (storedLogo) {
// //           setBrandLogo(storedLogo);
// //         } else if (prods.length > 0 && prods[0].company_id) {
// //           const companyInfo = prods[0].company_id;
// //           if (typeof companyInfo !== 'string' && companyInfo.company_logo) {
// //             setBrandLogo(companyInfo.company_logo);
...
// //       // Process Global Promo Sliders
// //       if (globalDataResponse && globalDataResponse.success) {
// //         setPromoSliders(globalDataResponse.promoProducts || []);
// //       } else {
// //         const err =
...
// //           closeModals();
// //           router.replace('/thankyou'); // Use replace to prevent back navigation to payment
// //         } else {
// //           throw new Error('Order confirmation failed');
// //         }
// //         return;
...
// //       document.body.appendChild(form);
// //       form.submit();
// //       document.body.removeChild(form); // Clean up form after submission attempt

// //       // Do not remove from cart here for payment gateways, do it on success
// //     } catch (error: any) {
// //       console.error('Order placement error:', error);
// //       toast.error(
// //         error.message || 'An unexpected error occurred during checkout'
...
// //                     }}
// //                     className="w-full h-full object-contain p-2" // p-2 to prevent image touching edges
// //                   />
// //                 </figure>
// //                 <div className="at-giftdetails p-3 flex-grow flex flex-col justify-between">
// //                   <div>
...
// //     if (loading && promoSliders.length === 0) {
// //       return (
// //         <div className="mt-8">
// //           <Skeleton className="h-8 w-48 mb-4" />
// //           <Skeleton className="h-60 w-full mb-4" /> {/* For main promo image */}
// //         </div>
// //       );
// //     }
// //     if (!loading && promoSliders.length === 0) {
...
// //           <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
// //             {typeof brandname === 'string'
// //               ? unslugify(decodeURIComponent(brandname)) // Use unslugify for better display
// //               : 'Brand'}{' '}
// //             Shop
// //           </h1>
// //         </div>
...
// //       {/* --- Modals (Styled like category_page.tsx) --- */}
// //       {isFirstModalOpen &&
// //         selectedProduct &&
// //         (() => {
...
// //                     p.company_id?._id === selectedProduct.company_id
// //                 )?.company_id ?? {
// //                   name:
// //                     typeof brandname === 'string'
// //                       ? decodeURIComponent(brandname)
...
// //           const modalBackgroundStyle = getModalLeftPanelStyle(selectedProduct);
// //           const contentImages = selectedProduct.background_image ?? [];
// //           let currentContentImageSrc = PRODUCT_PLACEHOLDER; // Fallback
// //           if (
// //             contentImages.length > 0 &&
// //             currentImageSliderIndex < contentImages.length &&
// //             contentImages[currentImageSliderIndex] !== null
...
// //             >
// //               <div
// //                 className="bg-white rounded-lg shadow-lg at-modaldailouge w-full max-w-3xl" // Ensure width is constrained
// //                 onClick={(e) => e.stopPropagation()}
// //               >
// //                 <div className="flex flex-col md:flex-row">
// //                   {' '}
// //                   {/* Use flex-col for overall structure */}
// //                   {/* Left Side (Image) for Order Summary */}
// //                   <div
// //                     className="at-modalleftside at-modalordersummeryleft w-full md:w-[40%] flex-shrink-0 p-6 flex items-center justify-center relative" // Match style from category_page
// //                     style={modalBackgroundStyle}
// //                   >
// //                     <button
// //                       onClick={closeModals}
// //                       className="at-btnpopupclose at-btnpopupclosetwo" // Consistent close button
// //                     >
// //                       <svg
// //                         width="32"
// //                         height="32"
...
// //                   {/* <div className="at-popupcontentside w-full md:w-[60%] p-6 flex flex-col">
...
// //                       </div>
// //                       <div className="at-orderquntatiy">
// //                         <div className="at-btnquntatiyholder flex items-center">
// //                           <button
// //                             onClick={decreaseQuantity}
// //                             disabled={quantity === 1}
// //                             className="px-3 py-1 border rounded-l bg-gray-200 hover:bg-gray-300 disabled:opacity-50"
// //                           >
// //                             -
// //                           </button>
...
// //                       </div>
// //                     </div>
// //                     <div className="at-ordersummery mb-auto">
...
// //                           <span>Rs.{finalProductPrice.toFixed(2)}</span>
// //                         </li>
// //                         <li className="flex justify-between">
// //                           <span>Quantity:</span>
// //                           <span>{quantity}</span>
...
// //                           <span>Subtotal:</span>
// //                           <span>
// //                             Rs.{(finalProductPrice * quantity).toFixed(2)}
// //                           </span>
// //                         </li>
// //                         <li className="flex justify-between">
// //                           <span>Sales Tax (17%):</span>
// //                           <span>
// //                             Rs.
// //                             {(finalProductPrice * quantity * 0.17).toFixed(2)}
// //                           </span>
// //                         </li>
// //                         <li className="flex justify-between font-bold text-base pt-2 border-t mt-2">
// //                           <span>Grand Total:</span>
// //                           <span>
// //                             Rs.
// //                             {(finalProductPrice * quantity * 1.17).toFixed(2)}
// //                           </span>
// //                         </li>
// //                       </ul>
// //                     </div>
// //                     <div className="at-btnsubmitcontact at-btnprofile at-btnplaceorder mt-6 flex flex-col sm:flex-row gap-3">
// //                       <button
// //                         type="button"
// //                         className="at-btn flex-1"
// //                         onClick={handlePlaceOrder}
// //                         disabled={processing}
// //                       >
// //                         {processing ? 'Processing...' : 'Place Order'}
...
//         // Set brand logo from the first product of the brand or sessionStorage
//         const storedLogo = sessionStorage.getItem(`brandLogo_${brandId}`); // Make logo storage brand-specific
//         if (storedLogo) {
//           setBrandLogo(storedLogo);
//         } else if (prods.length > 0 && prods[0].company_id) {
//           const companyInfo = prods[0].company_id;
...
//         const brandSpecificPromos = allPromoProductsFromAPI.filter(
//           (promo: { products_data: any[] }) => {
//             if (promo.products_data && promo.products_data.length > 0) {
//               // Check if *any* product in this promo belongs to the current brand
...
//                       : (productData.company_id as CompanyMin)._id; // Cast to CompanyMin if object
...
//           }
//         );
//         setPromoSliders(brandSpecificPromos);
//       } else {
//         const err =
//           globalDataResponse?.message || 'Failed to load promo sliders';
//         fetchError = fetchError ? `${fetchError}; ${err}` : err;
...
//       setLoading(false);
//     }
//   }, [brandId]); // Added brandId to dependency array as it's used

//   useEffect(() => {
//     if (brandId) {
//       // Ensure brandId is present before fetching
//       fetchInitialData();
//     }
//   }, [brandId, fetchInitialData]); // Added brandId to dependency array
//   // --- End Data Fetching ---
...
//                       title={
//                         typeof brandname === 'string'
//                           ? decodeURIComponent(brandname as string)
//                           : 'Brand'
//                       }
//                     >
//                       {typeof brandname === 'string'
...
//   const renderPromoSlider = () => {
//     // promoSliders state is already filtered by brand relevance in fetchInitialData
...
//       // return (
//       //   <p className="mt-7 font-xl text-center text-gray-500">
//       //     No Deal of the Day promotions with products currently available for this brand.
//       //   </p>
//       // );
//       return;
//     }
...
//     alt={`${
//       typeof brandname === 'string'
//         ? unslugify(decodeURIComponent(brandname as string))
//         : 'Brand'
//     } logo`}
//     className="rounded-full border object-contain bg-white"
//   />
...
// <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
//   {typeof brandname === 'string'
//     ? unslugify(decodeURIComponent(brandname as string)) // Use unslugify for better display
//     : 'Brand'}{' '}
//   Shop
// </h1>
//         </div>
...
//           p.company_id !== null
//         ) {
//           return p.company_id._id === selectedProduct.company_id;
//         }
//         return false;
//       })?.company_id ?? {
//         name:
