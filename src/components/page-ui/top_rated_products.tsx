...
interface TopPicks {
  ...
  description: string;
  price: number;
  image_path: string | null; // Allow null for image_path
  background_image: string;
  total_rating: number;
  company_id: {
    _id: string;
    ...
    const getTopPicks = async () => {
      ...
      try {
        ...
        const errorMessage =
          err.response?.data?.message ||
          err.message ||
          'An error occurred while fetching top picks.';
        setError(errorMessage);
      } finally {
        setLoading(false);
      }
              ...
              <div className="flex justify-between items-center relative">
                <div className="at-modalcontent p-0">
                  ...
                  <div className="at-modalleftside p-0">
                    <figure className="at-productimg p-0 m-0">
                      <img
                        src={selectedTopRatedProduct.background_image[0] || PRODUCT_PLACEHOLDER}
                        alt={selectedTopRatedProduct.name}
                      />
                    </figure>
                  </div>
                      ...
                      {isInCart(selectedTopRatedProduct._id) ? (
                        ...
                        <button onClick={handleAddToCart} className="at-btn">
                          ...
                          >
                            <circle cx="16" cy="16" r="16" fill="white" />
                            <path
                              d="M24 16C24 16.3537 23.8644 16.6957 23.6108 16.9433C23.3631 17.1968 23.021 17.3382 22.6672 17.3382H17.3358V22.6677C17.3358 23.0214 17.1943 23.3633 16.9407 23.6109C16.693 23.8585 16.3568 24 16.0029 24C15.6491 24 15.307 23.8585 15.0593 23.610 9C14.8058 23.3633 14.6642 23.0214 14.6642 22.6677V17.3382H9.33284C8.97899 17.3382 8.63693 17.1968 8.38924 16.9433C8.14154 16.6957 8 16.3537 8 16C8 15.6463 8.14154 15.3102 8.38924 15.0567C8.63693 14.8091 8.97899 14.6676 9.33284 14.6676H14.6642V9.33825C14.6642 8.98452 14.8058 8.64259 15.0593 8.39499C15.307 8.14149 15.6491 8 16.0029 8C16.3568 8 16.693 8.14149 16.9407 8.39499C17.1943 8.64259 17.3358 8.98452 17.3358 9.33825V14.6676H22.6672C23.021 14.6676 23.3631 14.8091 23.6108 15.0567C23.8644 15.3102 24 15.6463 24 16Z"
                              fill="#40A574"
                            />
                          </svg>
                        </button>
