...
//         setGifts(giftsResponse || initialGiftState);
//       } catch (error) {
...
//         <span className={`text-sm mr-2 ${!showSentGifts ? 'font-bold' : ''}`}>Received</span>
//         <Switch
//           checked={showSentGifts}
//           onCheckedChange={setShowSentGifts}
//           className="data-[state=checked]:bg-blue-600"
//         />
//         <span className={`text-sm ml-2 ${showSentGifts ? 'font-bold' : ''}`}>Sent</span>
//       </div>
...
//                     <img
//                       className="mt-10"
//                       src={product.sticker_path || '/placeholder.png'}
              ...
              <div key={gift._id} className="at-shopcategorieitems">
                <div className="at-shopcategoriesgriditem">
                  <figure>
                    <img
                      className="mt-10"
                      src={product.sticker_path || PLACEHOLDER_IMAGE}
                      alt={product.name || 'Placeholder Image'}
                    />
                  </figure>
                  <div className="at-mygiftbrandname mt-8">
                    <h3>{getCompanyName(product.company_id || '')}</h3>
                    <h4 style={{ marginTop: '12px' }}>{product.name || 'Product Name'}</h4>
                  </div>
                  <div className="text-center mt-2 text-sm">
                    <span
                      className={`inline-block mt-2 px-3 py-1 rounded-full text-xs ${
