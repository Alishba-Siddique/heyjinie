...
const CheckOutPage = () => {
  ...
  const handlePayFastCheckout = async () => {
    ...
    try {
      ...
      setProcessing(false); // This might not run if form.submit() navigates away immediately.
                           // Consider disabling button permanently on click until navigation or error.
    }
  };
